package br.edu.iftm.contatos.controller;
...
import br.edu.iftm.contatos.domain.Contato;

@RestController
@RequestMapping("/contatos") // aqui ele força a classe colocar tudo dentro dela referente a contatos

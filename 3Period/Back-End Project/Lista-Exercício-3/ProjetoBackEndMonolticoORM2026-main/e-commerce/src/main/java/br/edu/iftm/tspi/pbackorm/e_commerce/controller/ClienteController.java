...
public class ClienteController {
    ...
    public ResponseEntity<ClienteDTO> novo(@Valid @RequestBody ClienteDTO dto) {
        Cliente clienteSalvo = repository.save(mapper.toEntity(dto));
    ...
    public ResponseEntity<ClienteDTO> atualizar(@PathVariable String clienteId,
        ...
        Cliente clienteAtualizar = mapper.toEntity(dto);
        clienteAtualizar.setId(clienteId);
        Cliente clienteAtualizado = repository.save(clienteAtualizar);

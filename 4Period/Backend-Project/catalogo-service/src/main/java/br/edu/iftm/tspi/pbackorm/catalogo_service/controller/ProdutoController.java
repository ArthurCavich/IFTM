...
import br.edu.iftm.tspi.pbackorm.catalogo_service.service.ProdutoService;
...
public class ProdutoController {
    ...
    public ResponseEntity<Void> atualizarEstoque(@PathVariable Integer id,
                                 @RequestBody Map<String, Short> quantidade) {
        produtoService.atualizarEstoque(id, quantidade.get("quantidade"));
